...
if command -v "$PYEXEC" >/dev/null 2>&1; then
  ...
  echo "Warning: $PYEXEC not found in PATH. Virtualenv not created. Install Python 3.12 or adjust PATH to create it."
fi
